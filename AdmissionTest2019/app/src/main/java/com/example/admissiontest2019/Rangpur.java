    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Img_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(Rangpur.this, android.Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){

                    ActivityCompat.requestPermissions(Rangpur.this,new String[]{android.Manifest.permission.CALL_PHONE},REQUEST_CALL);
                }
                else{

                    Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" +"01737670861"));
        ...
        Img_Secondcall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(Rangpur.this, android.Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){
                    ...
                    Intent amit = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" +"01792787430"));
        ...
        Img_msg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", "01737670861", null)));
            }
        });
        ...
        Img_Secondmsg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", "01792787430", null)));
