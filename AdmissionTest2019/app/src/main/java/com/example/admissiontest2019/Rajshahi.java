    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Img_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(Rajshahi.this, android.Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){

                    ActivityCompat.requestPermissions(Rajshahi.this,new String[]{android.Manifest.permission.CALL_PHONE},REQUEST_CALL);
                }
                else{

                    Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" +"01701021726"));
        ...
        Img_Secondcall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(Rajshahi.this, android.Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){
                    ...
                    Intent amit = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" +"01749787078"));
        ...
        Img_msg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", "01701021726", null)));
            }
        });
        ...
        Img_Secondmsg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", "01749787078", null)));
