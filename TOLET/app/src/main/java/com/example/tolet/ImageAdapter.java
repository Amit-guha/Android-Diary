...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public ImageAdapter(Context context, List<House> houseList) {
    ...
    public void onBindViewHolder(@NonNull final ImageViewHolder holder, int position) {
        ...
        final House CurrentItem = houseList.get(position);
       ...
       // Picasso.with(context)
        ...
        Picasso.with(context).load(CurrentItem.getmImageUrl()).networkPolicy(NetworkPolicy.OFFLINE).into(holder.imageView, new Callback() {
            @Override
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            tv_name = itemView.findViewById(R.id.Card_Textview);
